...
png("./03_plots/01_QC/QC_2_QC6_PCADIMENSIONS_PCA2.png")
DimPlot(NPC_QC, reduction = "pca")
dev.off()

png("./03_plots/01_QC/QC_2_QC6_PCADIMENSIONS_ELBOW.png")
...
png("./03_plots/01_QC/QC_2_REGRESSION_CLUSTERR1 for REGRESSION Test.png")
...
#table(NPC_QC[[]]$Phase)
png("./03_plots/01_QC/QC_2_REGRESSION_GENES_UMIs.png")
...
png("./03_plots/01_QC/QC_2_REGRESSION_CELLCYCLESCORE.png")
...
# dev.off()
# png("./03_plots/01_QC/QC_3_CLUSTERING_R8.png")
# DimPlot(NPC_ALL_TRANSFORM_R8, label = T , repel = T, label.size = 3)
# dev.off()
# png("./03_plots/01_QC/QC_3_CLUSTERING_R10.png")
